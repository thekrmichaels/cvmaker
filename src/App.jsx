...
const UserDropdown = lazy(() => import("./components/UserDropdown"));
...
const Footer = ({ bgClass, textClass }) => (
  <footer
    className={`${bgClass} ${textClass} w-full py-4 text-center font-normal shadow-[0_-1px_2px_0_#747775] dark:shadow-[0_-1px_2px_0_#8E918F]`}
  >
    <p>
      Developed by{" "}
      <a
