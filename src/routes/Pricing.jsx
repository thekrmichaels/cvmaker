...
const Pricing = () => {
  ...
  return (
    <div
      className={`mt-24 flex flex-col items-center justify-center gap-6 p-6 md:flex-row ${themeStyle}`}
    >
      {plans.map((plan, index) => (
        <Card
          ...
          title={plan.title}
          subTitle={plan.price}
          className={`card w-full border border-[#747775] shadow-lg ${themeStyle}`}
          style={{
              ...
              <div className="mt-auto text-center">
                <a href={plan.link} target="_blank" rel="noopener noreferrer">
                  <Button
                    ...
                    className={`${themeStyle} w-full border border-[#747775] hover:bg-opacity-50`}
                    severity="secondary"
                  />
                </a>
              </div>
